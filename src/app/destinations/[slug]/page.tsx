...
export default function DestinationDetailPage({
  ...
  const destination = DESTINATIONS.find((d) => d.slug === params.slug || d.id === params.slug);
  ...
  const associatedCircuits = CIRCUITS.filter((c) => c.destinationId === destination.id);
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-stone-100">
              ...
              <div className="bg-stone-50 p-4 rounded-2xl border border-stone-200 space-y-1">
                ...
                <p className="text-xs text-stone-700 font-medium">{destination.bestPeriod}</p>
              </div>
            </div>
          </div>
