...
export const TASK_TEMPLATES: TaskTemplate[] = [
  {
    ...
    items: [
      item({ title: "Confirmer les réservations hôtels/lodges", phase: "AVANT", category: "FOURNISSEURS", dueOffsetDays: -45, assigneeRole: "AGENT", supplierTag: "Hébergement", priority: "URGENTE" }),
      ...
      item({ title: "Confirmer transport 4x4 et chauffeur", phase: "AVANT", category: "LOGISTIQUE", dueOffsetDays: -20, assigneeRole: "AGENT", supplierTag: "Transport" }),
      ...
      item({ title: "Solder les paiements fournisseurs", phase: "APRES", category: "FINANCE", dueOffsetDays: 5, assigneeRole: "AGENT", supplierTag: "Hébergement" }),
    ],
  },
  {
    id: "tt-culture-benin",
    ...
    items: [
      item({ title: "Confirmer les hébergements du circuit", phase: "AVANT", category: "FOURNISSEURS", dueOffsetDays: -30, assigneeRole: "AGENT", supplierTag: "Hébergement" }),
      ...
      item({ title: "Réserver les guides culturels locaux", phase: "AVANT", category: "FOURNISSEURS", dueOffsetDays: -14, assigneeRole: "AGENT", supplierTag: "Guide local" }),
  ...
  },
  {
    ...
    items: [
      item({ title: "Valider le lieu et le traiteur", phase: "AVANT", category: "FOURNISSEURS", dueOffsetDays: -30, assigneeRole: "AGENT", supplierTag: "Traiteur", priority: "URGENTE" }),
      ...
      item({ title: "Confirmer le transport groupe", phase: "AVANT", category: "LOGISTIQUE", dueOffsetDays: -10, assigneeRole: "AGENT", supplierTag: "Transport" }),
      ...
      item({ title: "Solder les paiements fournisseurs", phase: "APRES", category: "FINANCE", dueOffsetDays: 3, assigneeRole: "AGENT", supplierTag: "Traiteur" }),
    ],
  },
];
